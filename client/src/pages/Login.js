      ...
      <>
        <section className="section section-shaped section-lg">
          ...
          <Row className="justify-content-center mb--6 mt-4">
                  <h4 className="text-white font-italic">Log In to</h4>
                  <h4 className="text-success ml-1 font-italic">Create Checklists</h4>
                  <h4 className="text-white font-italic ml-1">or</h4>
                  <h4 className="text-success ml-1 font-italic">Views Resources</h4>
                ...
                <Card className="bg-secondary shadow border-0">
                  <CardHeader className="bg-white pb-2">
                      <div className="text-muted text-center mb-3">
                        ...
                        <h4 className="text-primary font-weight-bold font-italic">Log In</h4>
                      </div>
